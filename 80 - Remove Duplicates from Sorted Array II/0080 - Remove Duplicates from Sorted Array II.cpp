// 0080 - Remove Duplicates from Sorted Array II.cpp : This file contains the 'main' function. Program execution begins and ends there.
...
int main()
{
    ...
    // Case 1
    nums = { 1, 1, 1, 2, 2, 3 };
    countValues = solution1.removeDuplicates(nums);
    std::cout << countValues << std::endl;
    std::cout << Helpers::VectorToString<int>(nums) << std::endl;
