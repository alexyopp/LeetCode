// 0027 - Remove Element.cpp : This file contains the 'main' function. Program execution begins and ends there.
...
int main()
{
    ...
    nums = { 3, 2, 2, 3 };
    val = 3;
    removedValuesCount = solution1.removeElement(nums, val);
    std::cout << removedValuesCount << std::endl;
