//*****************************************************************************************************************************
// You are given a string "s" consisting of lowercase English letters and the special characters: *, #, and %.  Build a new
// string result by processing s according to the following rules from left to right:
...
int main()
{
    ...
    auto processStrCallable = [&solution](std::string s) { return solution.processStr(s); };
